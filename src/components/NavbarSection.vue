<template>
  <nav class="navbar navbar-expand-lg bg-white fixed-top" id="scrollNavbar">
  <div class="container-fluid header-padding">
    <a class="navbar-brand" href="/"><img src="../assets/logo.png" height="23" width="180" alt=""></a>
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav ms-auto mb-4 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#specialist">DaCode Specialists</a>
        </li>
        <li class="nav-item">
      ...
      <a class="cta ms-lg-4" href="#">Request a quote</a>
    </div>
  </div>
</nav>
</template>
